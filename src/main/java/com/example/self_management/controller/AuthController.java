...
import com.example.self_management.security.jwt.AuthService;
...
public class AuthController {
    ...
    public AuthController (AuthService authService, JwtService jwtService, PasswordEncoder passwordEncoder, UserService userService, UserRepository userRepository){
    ...
    @PostMapping("/refresh")
    public ResponseEntity<JwtResponse> refresh(@RequestBody RefreshToken request) {
